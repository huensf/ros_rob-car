...
% Forward Kinematics 
  ...
  ALPHA29 = C8*(ALPHA25+BETA46*s.dpt(1,1)+BETA66*s.dpt(3,1)+BS56*s.dpt(2,1))+S8*(ALPHA36+BETA76*s.dpt(1,1)+BETA86*s.dpt(2,1)+BS96*s.dpt(3,1))-...
 s.dpt(2,18)*(OM18*OM18+OM38*OM38);
  ...
  ALPHA214 = C13*(ALPHA25+BETA46*s.dpt(1,2)+BETA66*s.dpt(3,2)+BS56*s.dpt(2,2))+S13*(ALPHA36+BETA76*s.dpt(1,2)+BETA86*s.dpt(2,2)+BS96*s.dpt(3,2))-...
 s.dpt(2,25)*(OM113*OM113+OM313*OM313);
  ...
  ALPHA235 = C35*(ALPHA25+BETA46*s.dpt(1,12)+BETA66*s.dpt(3,12)+BS56*s.dpt(2,12))+S35*(ALPHA36+BETA76*s.dpt(1,12)+BETA86*s.dpt(2,12)+BS96*...
 s.dpt(3,12));
  ALPHA335 = C35*(ALPHA36+BETA76*s.dpt(1,12)+BETA86*s.dpt(2,12)+BS96*s.dpt(3,12))-S35*(ALPHA25+BETA46*s.dpt(1,12)+BETA66*s.dpt(3,12)+BS56*...
 s.dpt(2,12));
  OM136 = qd(36)+OM135;
  ...
  ALPHA238 = C38*(ALPHA25+BETA46*s.dpt(1,13)+BETA66*s.dpt(3,13)+BS56*s.dpt(2,13))+S38*(ALPHA36+BETA76*s.dpt(1,13)+BETA86*s.dpt(2,13)+BS96*...
 s.dpt(3,13));
  ALPHA338 = C38*(ALPHA36+BETA76*s.dpt(1,13)+BETA86*s.dpt(2,13)+BS96*s.dpt(3,13))-S38*(ALPHA25+BETA46*s.dpt(1,13)+BETA66*s.dpt(3,13)+BS56*...
 s.dpt(2,13));
  OM139 = qd(39)+OM138;
  ...
  ALPHA247 = C47*(ALPHA25+BETA46*s.dpt(1,17)+BETA66*s.dpt(3,17)+BS56*s.dpt(2,17))+S47*(ALPHA36+BETA76*s.dpt(1,17)+BETA86*s.dpt(2,17)+BS96*...
 s.dpt(3,17));
  ALPHA347 = C47*(ALPHA36+BETA76*s.dpt(1,17)+BETA86*s.dpt(2,17)+BS96*s.dpt(3,17))-S47*(ALPHA25+BETA46*s.dpt(1,17)+BETA66*s.dpt(3,17)+BS56*...
 s.dpt(2,17));
...
% Backward Dynamics 
  ...
  Cq250 = -(s.trq(2,50)-s.In(5,50)*(C50*(OMp249+qd(50)*OM349)+S50*(OMp349-qd(50)*OM249))-OM150*OM350*(s.In(1,50)-s.In(9,50)));
  Cq350 = -(s.trq(3,50)-s.In(9,50)*(C50*(OMp349-qd(50)*OM249)-S50*(OMp249+qd(50)*OM349))+OM150*OM250*(s.In(1,50)-s.In(5,50)));
  ...
  Cq341 = -(s.trq(3,41)+s.trq(2,46)*S45+Cq142*S42-Cq342*C42-Cq345*C45+Fq145*s.dpt(2,60)+s.dpt(1,60)*(s.frc(2,46)*C45+Fq345*S45));
  ...
  Cq140 = -(s.trq(1,40)-s.In(1,40)*(C40*(OMp139-qd(40)*OM339)-S40*(OMp339+qd(40)*OM139))+OM240*OM340*(s.In(5,40)-s.In(9,40)));
  Cq240 = -(s.trq(2,40)-s.In(5,40)*(qdd(40)+OMp239)-OM140*OM340*(s.In(1,40)-s.In(9,40)));
  Cq340 = -(s.trq(3,40)-s.In(9,40)*(C40*(OMp339+qd(40)*OM139)+S40*(OMp139-qd(40)*OM339))+OM140*OM240*(s.In(1,40)-s.In(5,40)));
  ...
  Cq137 = -(s.trq(1,37)-s.In(1,37)*(C37*(OMp136-qd(37)*OM336)-S37*(OMp336+qd(37)*OM136))+OM237*OM337*(s.In(5,37)-s.In(9,37)));
  Cq237 = -(s.trq(2,37)-s.In(5,37)*(qdd(37)+OMp236)-OM137*OM337*(s.In(1,37)-s.In(9,37)));
  Cq337 = -(s.trq(3,37)-s.In(9,37)*(C37*(OMp336+qd(37)*OM136)+S37*(OMp136-qd(37)*OM336))+OM137*OM237*(s.In(1,37)-s.In(5,37)));
  ...
  Cq134 = -(s.trq(1,34)-s.In(1,34)*(C34*(OMp16+qd(34)*OM26)+S34*(OMp26-qd(34)*OM16))+OM234*OM334*(s.In(5,34)-s.In(9,34)));
  Cq234 = -(s.trq(2,34)-s.In(5,34)*(C34*(OMp26-qd(34)*OM16)-S34*(OMp16+qd(34)*OM26))-OM134*OM334*(s.In(1,34)-s.In(9,34)));
  ...
  Cq322 = -(s.trq(3,22)+s.trq(2,24)*S23+Cq125*S25-Cq323*C23-Cq325*C25+Fq123*s.dpt(2,39)+s.dpt(1,39)*(s.frc(2,24)*C23+Fq323*S23));
  ...
  Cq117 = -(s.trq(1,17)-s.In(1,17)*(C17*(OMp116-qd(17)*OM316)-S17*(OMp316+qd(17)*OM116))+OM217*OM317*(s.In(5,17)-s.In(9,17)));
  Cq217 = -(s.trq(2,17)-s.In(5,17)*(qdd(17)+OMp216)-OM117*OM317*(s.In(1,17)-s.In(9,17)));
  Cq317 = -(s.trq(3,17)-s.In(9,17)*(C17*(OMp316+qd(17)*OM116)+S17*(OMp116-qd(17)*OM316))+OM117*OM217*(s.In(1,17)-s.In(5,17)));
  ...
  Cq112 = -(s.trq(1,12)-s.In(1,12)*(C12*(OMp111-qd(12)*OM311)-S12*(OMp311+qd(12)*OM111))+OM212*OM312*(s.In(5,12)-s.In(9,12)));
  Cq212 = -(s.trq(2,12)-s.In(5,12)*(qdd(12)+OMp211)-OM112*OM312*(s.In(1,12)-s.In(9,12)));
  Cq312 = -(s.trq(3,12)-s.In(9,12)*(C12*(OMp311+qd(12)*OM111)+S12*(OMp111-qd(12)*OM311))+OM112*OM212*(s.In(1,12)-s.In(5,12)));
  ...
  Fq16 = -(s.frc(1,18)+s.frc(1,19)+s.frc(1,20)+s.frc(1,21)-Fq113-Fq128-Fq135-Fq138-Fq18-Fs150-Fs16-Fs17-Fq122*C22-Fq141*C41-Fq322*S22-Fq341*S41);
  Fq26 = Fq222+Fq228+Fq241+Fs26+Fs27-s.frc(2,18)*C18-s.frc(2,19)*C19-s.frc(2,20)*C20-s.frc(2,21)*C21+s.frc(3,18)*S18+s.frc(3,19)*S19+s.frc(3,20)*...
 S20+s.frc(3,21)*S21+Fq213*C13+Fq235*C35+Fq238*C38+Fq247*C47+Fq28*C8-Fq313*S13-Fq335*S35-Fq338*S38-Fq347*S47-Fq38*S8;
  Fq36 = Fq328+Fs36+Fs37-s.frc(2,18)*S18-s.frc(2,19)*S19-s.frc(2,20)*S20-s.frc(2,21)*S21-s.frc(3,18)*C18-s.frc(3,19)*C19-s.frc(3,20)*C20-...
 s.frc(3,21)*C21-Fq122*S22-Fq141*S41+Fq213*S13+Fq235*S35+Fq238*S38+Fq247*S47+Fq28*S8+Fq313*C13+Fq322*C22+Fq335*C35+Fq338*C38+Fq341*C41+Fq347*C47+Fq38*...
 C8;
  Cq16 = -(s.trq(1,18)+s.trq(1,19)+s.trq(1,20)+s.trq(1,21)+s.trq(1,28)+s.trq(1,6)+s.trq(1,7)-Cq113-Cq129-Cq131-Cq135-Cq138-Cq150-Cq18-q(28)*Fq328...
 -s.In(1,6)*OMp16-Cq122*C22-Cq134*C34-Cq141*C41+Cq234*S34-Cq322*S22-Cq341*S41-Dz332*Fs334+Fq222*s.dpt(3,8)+Fq228*s.dpt(3,9)+Fq241*s.dpt(3,15)+Fs26*...
 s.l(3,6)+OM26*OM36*(s.In(5,6)-s.In(9,6))-s.dpt(2,1)*(Fq28*S8+Fq38*C8)-s.dpt(2,12)*(Fq235*S35+Fq335*C35)-s.dpt(2,13)*(Fq238*S38+Fq338*C38)-s.dpt(2,17)...
 *(Fq247*S47+Fq347*C47)-s.dpt(2,2)*(Fq213*S13+Fq313*C13)+s.dpt(2,3)*(s.frc(2,18)*S18+s.frc(3,18)*C18)+s.dpt(2,4)*(s.frc(2,19)*S19+s.frc(3,19)*C19)+...
 s.dpt(2,44)*(s.frc(3,30)*C29-Fq229*S29)+s.dpt(2,45)*(s.frc(3,32)*C31-Fq231*S31)+s.dpt(2,5)*(s.frc(2,20)*S20+s.frc(3,20)*C20)+s.dpt(2,7)*(s.frc(2,21)*...
 S21+s.frc(3,21)*C21)+s.dpt(3,1)*(Fq28*C8-Fq38*S8)+s.dpt(3,12)*(Fq235*C35-Fq335*S35)+s.dpt(3,13)*(Fq238*C38-Fq338*S38)+s.dpt(3,17)*(Fq247*C47-Fq347*...
 S47)+s.dpt(3,2)*(Fq213*C13-Fq313*S13));
  Cq26 = -(s.trq(2,28)+s.trq(2,6)+s.trq(2,7)-Cq222-Cq241+q(7)*Fs37-s.In(5,6)*OMp26+s.trq(2,18)*C18+s.trq(2,19)*C19+s.trq(2,20)*C20+s.trq(2,21)*...
 C21-s.trq(3,18)*S18-s.trq(3,19)*S19-s.trq(3,20)*S20-s.trq(3,21)*S21-s.trq(3,30)*S29-s.trq(3,32)*S31-Cq134*S34-Cq213*C13-Cq229*C29-Cq231*C31-Cq234*C34...
 -Cq235*C35-Cq238*C38-Cq247*C47-Cq28*C8+Cq313*S13+Cq335*S35+Cq338*S38+Cq347*S47+Cq38*S8-Fq113*s.dpt(3,2)-Fq128*s.dpt(3,9)-Fq135*s.dpt(3,12)-Fq138*...
 s.dpt(3,13)-Fq18*s.dpt(3,1)+Fq328*s.dpt(1,9)-Fs150*s.dpt(3,17)-Fs16*s.l(3,6)+Fs36*s.l(1,6)-OM16*OM36*(s.In(1,6)-s.In(9,6))+s.dpt(1,1)*(Fq28*S8+Fq38*...
 C8)+s.dpt(1,12)*(Fq235*S35+Fq335*C35)+s.dpt(1,13)*(Fq238*S38+Fq338*C38)-s.dpt(1,15)*(Fq141*S41-Fq341*C41)+s.dpt(1,17)*(Fq247*S47+Fq347*C47)+...
 s.dpt(1,2)*(Fq213*S13+Fq313*C13)-s.dpt(1,5)*(s.frc(2,20)*S20+s.frc(3,20)*C20)-s.dpt(1,7)*(s.frc(2,21)*S21+s.frc(3,21)*C21)-s.dpt(1,8)*(Fq122*S22-...
 Fq322*C22)-s.dpt(3,15)*(Fq141*C41+Fq341*S41)-s.dpt(3,8)*(Fq122*C22+Fq322*S22));
  Cq36 = -(s.trq(3,28)+s.trq(3,6)+s.trq(3,7)-Cq334+q(28)*Fq128-q(7)*Fs27-s.In(9,6)*OMp36-s.frc(1,18)*s.dpt(2,3)-s.frc(1,19)*s.dpt(2,4)-...
 ...
 s.trq(3,20)*C20+s.trq(3,21)*C21+s.trq(3,30)*C29+s.trq(3,32)*C31+Cq122*S22+Cq141*S41-Cq213*S13-Cq229*S29-Cq231*S31-Cq235*S35-Cq238*S38-Cq247*S47-Cq28*...
 S8-Cq313*C13-Cq322*C22-Cq335*C35-Cq338*C38-Cq341*C41-Cq347*C47-Cq38*C8+Dz332*Fq133+Fq113*s.dpt(2,2)+Fq129*s.dpt(2,44)+Fq131*s.dpt(2,45)+Fq135*...
 s.dpt(2,12)+Fq138*s.dpt(2,13)+Fq18*s.dpt(2,1)-Fq222*s.dpt(1,8)-Fq228*s.dpt(1,9)-Fq241*s.dpt(1,15)+Fs150*s.dpt(2,17)-Fs26*s.l(1,6)+OM16*OM26*(...
 s.In(1,6)-s.In(5,6))-s.dpt(1,1)*(Fq28*C8-Fq38*S8)-s.dpt(1,12)*(Fq235*C35-Fq335*S35)-s.dpt(1,13)*(Fq238*C38-Fq338*S38)-s.dpt(1,17)*(Fq247*C47-Fq347*...
 S47)-s.dpt(1,2)*(Fq213*C13-Fq313*S13)+s.dpt(1,5)*(s.frc(2,20)*C20-s.frc(3,20)*S20)+s.dpt(1,7)*(s.frc(2,21)*C21-s.frc(3,21)*S21));
